...
export default function Home({ rooms = [] }) {
    ...
    const displayRooms = rooms.length > 0 ? rooms.slice(0, 3) : defaultRooms;
                    ...
                    <div className="row g-4 text-center">
                        <div className="col-md-4">
                            <div className="p-4 bg-white rounded shadow-sm border border-light h-100 hover-lift" style={{ transition: 'all 0.3s ease' }}>
                                ...
                                <h3 className="display-4 fw-bold text-navy" style={{ color: 'var(--navy-dark, #0c192c)' }}>50+</h3>
                    ...
                    <div className="row g-5">
                        <div className="col-lg-5">
                            ...
                            <div className="card border-0 shadow-sm p-4 bg-white">
                                ...
                                <Link href={route('contact') + '#schedule'} className="btn btn-outline-dark w-100">Schedule Activities</Link>
                            </div>
                        </div>
