                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-lg-5" data-aos="fade-left">
                            <div style={{ background: "#fff", borderRadius: "16px", boxShadow: "0 12px 48px rgba(65,53,14,0.14)", padding: "36px", position: "sticky", top: "100px" }}>
                                ...
                                <a href="https://osltravels.co.ke/property/hotel/8?name=KINGA%20RESORTS&price=%2460%20%2F%20KES%207%2C800" target="_blank" rel="noopener noreferrer" style={{ display: "block", width: "100%", padding: "15px 0", background: "linear-gradient(135deg, #c9a84c, #a07830)", color: "#fff", borderRadius: "10px", textAlign: "center", textDecoration: "none", fontSize: "1rem", fontWeight: 700, letterSpacing: "0.06em", boxShadow: "0 4px 20px rgba(160,120,48,0.35)", marginBottom: "12px" }}>Book This Room</a>
                                <p style={{ color: "#6b5c3e", fontSize: "0.8rem", textAlign: "center", marginTop: "8px", marginBottom: "16px" }}><i className="fas fa-shield-alt text-gold me-1"></i> Bookings and payments securely handled by OSL Travels.</p>
